...
Este proyecto consiste en un sistema tipo CRM (Customer Relationship Management) realizado con fines educativos, cuyo objetivo es aplicar los conocimientos adquiridos durante el curso en un entorno práctico.
...
- Manejo de datos dentro de la aplicación  
...
3. Ejecutar la aplicación según su tecnología base  
4. Acceder al sistema desde el entorno configurado  
